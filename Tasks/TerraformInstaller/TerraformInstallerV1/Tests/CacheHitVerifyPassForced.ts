...
const tp = path.join(__dirname, 'CacheHitVerifyPassForcedL0.js');
...
// distinct from CacheHitReverifyPass, where there is no marker at all. The point
// of this fixture is that a passing marker must NOT be trusted: the download
// path below must still run.
