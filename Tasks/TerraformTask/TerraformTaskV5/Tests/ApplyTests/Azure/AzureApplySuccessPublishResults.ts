...
let tp = path.join(__dirname, './AzureApplySuccessPublishResultsL0.js');
...
const events = [
    ...
    { '@level': 'info', '@message': 'Outputs: 1', '@timestamp': '2026-07-15T00:00:03.000000Z', outputs: { rg_name: { sensitive: false, type: 'string', value: 'example-rg' } }, type: 'outputs' },
];
