...
const tempDir = path.join(os.tmpdir(), 'tpm-mirror-exclude');
...
tr.setInput('directIncludePatterns', 'registry.terraform.io/hashicorp/aws');
tr.setInput('mirrorExcludePatterns', 'registry.terraform.io/hashicorp/aws');
