...
// #1030's negative control: requireGpgSignature IS meaningful for Sentinel --
// setting it explicitly here must NOT trigger the "inert for this agent"
// warning that fires for policyAgent=opa. Without this, the OPA-only scoping
// in policy-agent-installer.ts could be dropped entirely and nothing would
// catch it (proved: this exact mutation survived until this fixture existed).
