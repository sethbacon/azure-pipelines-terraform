...
async function run() {
    ...
    // unawaited rejection anywhere in a helper (e.g. a fire-and-forget call
    // inside processArticleImages) no longer falls through to Node's default
    // handling with no tasks.setResult call and no deterministic exit code.
